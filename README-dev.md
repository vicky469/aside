...
- `npm test` runs the Node test suite. The DGX bridge socket integration tests auto-skip outside DGX Spark devices; set `SIDENOTE2_RUN_DGX_BRIDGE_SOCKET_TESTS=1` to force them.
