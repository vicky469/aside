...
- [x] **Step 1: Replace flag-era assertions with the approved settings order and visibility contract**
...
- [x] **Step 2: Replace publishing validation/controller flag tests**
...
- [x] **Step 3: Add legacy settings cleanup coverage**
...
- [x] **Step 1: Make the catalog own the exact approved order and advanced labels**
...
- [x] **Step 2: Make publishing validation depend only on the visible toggle**
...
- [x] **Step 3: Remove feature flags from runtime settings and startup**
...
- [x] **Step 4: Drop legacy persisted flags safely**
...
- [x] **Step 5: Delete the now-unreferenced flag modules and tests**
...
- [x] **Step 7: Commit the production migration**
...
- [x] **Step 1: Rename and rewrite the guide**

Use `# Advanced Features`, link both advanced workflows, retain the publishing security/network/workflow material, remove all local-storage activation snippets, and instruct users to open **Settings → Aside → Publishing (advanced)** and turn on **Enable publishing**. Update script documentation and in-app guidance to use **Settings → Aside → Scripts (advanced)**.

- [x] **Step 2: Update the README and documentation contract test**
...
- [x] **Step 3: Run the documentation test**
...
- [x] **Step 1: Re-run the change-surface audit**
...
- [x] **Step 3: Mark every design-spec tracking item complete with verification evidence**

Record the final test totals, bundle byte count, and exact release-artifact inspection result.

- [x] **Step 4: Commit verification tracking**
