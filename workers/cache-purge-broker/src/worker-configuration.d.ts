/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/cache-purge-broker/wrangler.jsonc workers/cache-purge-broker/src/worker-configuration.d.ts` (hash: 8a6345279df6c18e0a5a3b9c15ae4dfb)
// Runtime types generated with workerd@1.20260710.1 2026-07-15
interface __BaseEnv_Env {
	ALLOWED_HOSTS: "publish.fdechina.com";
	...
	PURGE_GUARD: DurableObjectNamespace<import("./index").PurgeGuard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "PurgeGuard";
	}
