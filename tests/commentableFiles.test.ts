...
test("commentable file helpers distinguish markdown and index files", () => {
    ...
    assert.equal(isMarkdownCommentablePath("aside/node_modules/package/README.md"), false);
    assert.equal(isMarkdownCommentablePath("aside/.test-dist/tests/generated.md"), false);
    assert.equal(isMarkdownCommentablePath(".git/COMMIT_EDITMSG.md"), false);
    ...
    assert.equal(isSidebarSupportedPath("aside/node_modules/package/README.md"), false);
});
