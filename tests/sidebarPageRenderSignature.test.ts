...
test("buildPageSidebarThreadRenderSignature changes when an entry body changes without other metadata moving", () => {
    const base = createThread();
    const edited = createThread({
        entries: [
            { id: "thread-1", body: "Parent entry edited", timestamp: 100 },
            { id: "entry-2", body: "Child entry", timestamp: 200 },
        ],
