import { addIcon, WorkspaceLeaf, TFile, TFolder, Notice, Plugin, normalizePath, MarkdownView, FileSystemAdapter, FileView, Platform, getAllTags, type Editor, type View } from "obsidian";
