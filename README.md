...
<p align="center">
  <a href="https://github.com/vicky469/aside/releases/tag/2.0.99">
    <img src="https://img.shields.io/badge/release-2.0.99-22c55e?style=flat-square" alt="Latest release">
  </a>
...
4. Experimental, for testers only: configure Cloudflare Pages publishing.
   ...
   - Enable the hidden setting: `npm run feature:flag -- --vault /path/to/vault --flag publish --on`. Use `--off` to hide it again.
